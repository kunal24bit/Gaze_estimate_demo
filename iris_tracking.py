...
def iris_position(iris_center, right_point, left_point, threshold):
...
def process_frame(frame, threshold):
    with mp_face_mesh.FaceMesh(
        ...
        if results.multi_face_landmarks:
            ...
            iris_pos, ratio = iris_position(center_right, mesh_points[R_H_RIGHT], mesh_points[R_H_LEFT][0], threshold)
            #print(iris_pos)
